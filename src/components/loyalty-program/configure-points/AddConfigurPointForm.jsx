...
function AddConfigurPointForm({ toggleAddConfigurPointModal, setToggleAddConfigurPointModal }) {
  console.log(toggleAddConfigurPointModal);
  ...
  return (
    <>
      <div className={`main-popup adduser-popup ${toggleAddConfigurPointModal ? 'pop-open' : 'pop-close'}`}>
        <div className="lm-outer">
          <div className="lm-inner">
            <div className="popup-inner">
              <div className='popup-header'>
                <div className='popup-heading'>
                  <h3>Add Configure Points</h3>
                </div>
              </div>
              <div className='popup-body'>
                  ...
                  <div className="mb-3 fv-row">
                    ...
                    <input type="text" name="Date" value="" className="form-control" placeholder="Enter Points" />
                </div>
                  <div className="mb-3 fv-row ">
                ...
                <button type="button" className="btn btn-shadow btn-secondary" onClick={() => { setToggleAddConfigurPointModal(p=> !p) }}>Cancel</button></div>
                 </div>
                  </div>
              </div>
        ...
        <div className="overlay" onClick={() => { setToggleAddConfigurPointModal(p=> !p) }}></div>
      </div>
    </>
  )
}
...
export default AddConfigurPointForm