...
import EditConfigurPointform from './EditConfigurPointform'

const ConfigurePointsTable = () => {
  const [toggleEditConfigurPointModal, setToggleEditConfigurPointModal] = useState(false)
  ...
  return (
                        ...
                        <tr key={item.orderId} className="">
                            ...
                            <td className=''>
                               <div className="d-flex justify-content-end align-items-center flex-shrink-0">
                                    <button onClick={()=>{setToggleEditConfigurPointModal(p=> !p)}} className="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-2">
    ...
    <EditConfigurPointform toggleEditConfigurPointModal={toggleEditConfigurPointModal} setToggleEditConfigurPointModal={setToggleEditConfigurPointModal} />
...
export default ConfigurePointsTable