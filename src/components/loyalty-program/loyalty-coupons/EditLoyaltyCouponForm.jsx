...
function EditLoyaltyCouponForm({ toggleEditLoyaltyCouponsModal, setToggleEditLoyaltyCouponsModal }) {
  console.log(toggleEditLoyaltyCouponsModal);
  ...
  return (
    <>
      <div className={`main-popup adduser-popup ${toggleEditLoyaltyCouponsModal ? 'pop-open' : 'pop-close'}`}>
        <div className="lm-outer">
          <div className="lm-inner">
            <div className="popup-inner">
              <div className='popup-header'>
                <div className='popup-heading'>
                  <h3>Edit Loyalty Coupons</h3>
                </div>
              </div>
              <div className='popup-body'>
                ...
                <button type="button" className="btn btn-shadow btn-secondary" onClick={() => { setToggleEditLoyaltyCouponsModal(p=> !p) }}>Cancel</button></div>
                 </div>
                  </div>
              </div>
        ...
        <div className="overlay" onClick={() => { setToggleEditLoyaltyCouponsModal(p=> !p) }}></div>
      </div>
    </>
  )
}
...
export default EditLoyaltyCouponForm