...
import EditLoyaltyCouponForm from './EditLoyaltyCouponForm'

const LoyaltyCouponTable = () => {
  const [toggleEditLoyaltyCouponsModal, setToggleEditLoyaltyCouponsModal] = useState(false)
  ...
  return (
            ...
            {dummyArray.map((item, index) => {
                    return (
                        <tr key={item.orderId} className="">
                            ...
                            <td className="text-center">lp9b9969</td>
                            <td className="text-center">Active</td>
                            <td className=''>
                               <div className="d-flex justify-content-end align-items-center flex-shrink-0">
                                    <button  onClick={()=>{setToggleEditLoyaltyCouponsModal(p=> !p)}} className="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-2">
    ...
    <EditLoyaltyCouponForm toggleEditLoyaltyCouponsModal={toggleEditLoyaltyCouponsModal} setToggleEditLoyaltyCouponsModal={setToggleEditLoyaltyCouponsModal} />
</>
  )
}


export default LoyaltyCouponTable