...
import EditManageCitiesForm from './EditManageCitiesForm';
...
const  ManageCitiesTable = () => {

  
  const [toggleEditManageCitiesModal, setToggleEditManageCitiesModal] = useState(false)
  ...
  return (
    <>
        ...
        <table className="table table-row-dashed">
          <thead>
            ...
            <th className="w-10px">#</th>
              <th className="w-250px">Cities</th>
              ...
              return (
                <tr key={item.orderId} className="">
                  ...
                  <div className="d-flex justify-content-end align-items-center flex-shrink-0">
																	...
																	<button  onClick={()=>{setToggleEditManageCitiesModal(p=> !p)}}  className="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-2">
      ...
      <EditManageCitiesForm toggleEditManageCitiesModal={toggleEditManageCitiesModal} setToggleEditManageCitiesModal={setToggleEditManageCitiesModal}/>
    </>
  );
};
...
export default ManageCitiesTable