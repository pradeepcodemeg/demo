...
function  EditManageCitiesForm({ toggleEditManageCitiesModal, setToggleEditManageCitiesModal }) {
...
const Cityoptions = [
  ...
  return (
    <>
      <div className={`main-popup categry-popup ${toggleEditManageCitiesModal ? 'pop-open' : 'pop-close'}`}>
          ...
          <div className="lm-inner">
            <div className="popup-inner">
              ...
              <div className='popup-body'>
                ...
                <button type="button" className="btn btn-shadow btn-secondary" onClick={() => { setToggleEditManageCitiesModal(p=> !p) }}>Cancel</button></div>
                 </div>
                  </div>
              </div>
        ...
        <div className="overlay" onClick={() => { setToggleEditManageCitiesModal(p=> !p) }}></div>
      </div>
    </>
  )
}
...
export default EditManageCitiesForm