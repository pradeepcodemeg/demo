...
const orders = [
  {
    ...
    answer: 'We are open to your complaints. Hence, you can reg....',
    dateTime:'24 May 2023 11:26 AM',
  },
  {
    category: 'Payments',
    question: 'What if I have a complaint regarding my order?',
      ...
      <div className="responsive-table">
        <table className="table table-row-dashed">
          <thead>
            ...
            <th className="w-200px">Question</th>
            <th className="w-200px">Answer</th>
              <th className="w-175px">Date-Time</th>
              ...
              return (
                <tr key={item.orderId} className="">
                  ...
                  <div className="svcrd-togl me-2">
																	...
																	<Link to="/edit-faq" className="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-2">
