...
const orders = [
  {
    bannerName: 'Top Banner',
    bannerCaption: 'Holi Banner',
  },
  {
    bannerName: 'Bottom Banner',
    bannerCaption: 'Diwali Banner',
  },
];
        ...
        <table className="table table-row-dashed">
          <thead>
            ...
            <th className="w-10px">#</th>
              <th className="w-175px">Banner</th>
              <th className="w-175px">Caption</th>
              <th className="w-100px text-center">Banner Image</th>
            ...
            {orders && orders.map((item, index) => {
              return (
                <tr key={item.orderId} className="">
                  ...
                  <td className=""> {item.bannerName}</td>
                  <td className=""> {item.bannerCaption}</td>
                  ...
                  <div className="d-flex justify-content-end align-items-center flex-shrink-0">
																	...
																	<Link to="/edit-banner" className="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-2">
