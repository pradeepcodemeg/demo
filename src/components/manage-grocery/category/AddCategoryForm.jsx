...
function AddCategoryForm({ toggleAddCategryModal, setToggleAddCategryModal }) {
  ...
  return (
    <>
      <div className={`main-popup categry-popup ${toggleAddCategryModal ? 'pop-open' : 'pop-close'}`}>
          ...
          <div className="lm-inner">
            <div className="popup-inner">
              ...
              <div className='popup-body'>
                ...
                <button type="button" className="btn btn-shadow btn-secondary" onClick={() => { setToggleAddCategryModal(p=> !p) }}>Cancel</button></div>
                 </div>
                  </div>
              </div>
        ...
        <div className="overlay" onClick={() => { setToggleAddCategryModal(p=> !p) }}></div>
      </div>
    </>
  )
}
