...
function  AddSubCategoryForm({ toggleAddSubCategryModal, setToggleAddSubCategryModal }) {
  const customStyles = {
  ...
  return (
    <>
      <div className={`main-popup categry-popup ${toggleAddSubCategryModal ? 'pop-open' : 'pop-close'}`}>
          ...
          <div className="lm-inner">
            <div className="popup-inner">
              ...
              <div className='popup-body'>
                ...
                <button type="button" className="btn btn-shadow btn-secondary" onClick={() => { setToggleAddSubCategryModal(p=> !p) }}>Cancel</button></div>
                 </div>
                  </div>
              </div>
        ...
        <div className="overlay" onClick={() => { setToggleAddSubCategryModal(p=> !p) }}></div>
      </div>
    </>
  )
}
